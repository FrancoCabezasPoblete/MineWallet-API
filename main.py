...
# Se crean el usuario_tiene_moneda
...
def update_usuario_tiene_moneda(id):
    usuario_tiene_moneda = Usuario_tiene_moneda.query.filter_by(id=id).first() #TODO: filtrar por id_moneda y id_usuario al mismo tiempo
